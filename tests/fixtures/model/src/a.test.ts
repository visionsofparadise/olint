// A quartic function exported normally, as if public, to prove the
// reference's test-path filter (isTestPath, matching *.test.ts) removes it
// from both lint and report output.
